...
namespace TestProject.IntegrationTest.Infra
{
    public class SqlServerTestFixture : IDisposable
    {
        ...
        const string network = "test-network-micro-servico-producao";
        internal const string ConnectionString = $"Server=localhost,{port}; Database=tech-challenge-micro-servico-producao-grupo-71; User ID=sa; Password={pwd}; MultipleActiveResultSets=true; TrustServerCertificate=True";
        ...
        private const string DatabaseContainerNameMssqlTools = "mssql-tools-micro-servico-producao";
